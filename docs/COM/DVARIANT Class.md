...
```
CONSTRUCTOR
CONSTRUCTOR (BYREF cv AS DVARIANT)
...
```
SUB Foo (BYREF cv AS DVARIANT)
   PRINT AfxDVARIANTToStr(cv)
END SUB
...
```
SUB Foo (BYVAL cv AS DVARIANT PTR)
   PRINT AfxDVARIANTToStr(cv)
END SUB
Foo @DVARIANT("Test string")
Foo @DVARIANT(12345)
...
```
OPERATOR & (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS DVARIANT
OPERATOR * (BYREF cv AS DVARIANT) AS VARIANT PTR
```
...
```
OPERATOR Let (BYREF cv AS DVARIANT)
...
OPERATOR += (BYREF cv AS DVARIANT)
OPERATOR -= (BYREF cv AS DVARIANT)
OPERATOR *= (BYREF cv AS DVARIANT)
OPERATOR /= (BYREF cv AS DVARIANT)
OPERATOR \= (BYREF cv AS DVARIANT)
OPERATOR Mod= (BYREF cv AS DVARIANT)
OPERATOR Imp= (BYREF cv AS DVARIANT)
OPERATOR Eqv= (BYREF cv AS DVARIANT)
OPERATOR ^= (BYREF cv AS DVARIANT)
```
...
OPERATOR / (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS DVARIANT
OPERATOR \ (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS DVARIANT
OPERATOR ^ (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS DOUBLE
OPERATOR Mod (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS INTEGER
OPERATOR - (BYREF cv AS DVARIANT) AS DVARIANT
```

Relational operators

```
OPERATOR = (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS BOOLEAN
OPERATOR <> (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS BOOLEAN
OPERATOR < (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS BOOLEAN
OPERATOR > (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS BOOLEAN
OPERATOR <= (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS BOOLEAN
...
```
OPERATOR And (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS INTEGER
OPERATOR Eqv (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS INTEGER
OPERATOR Imp (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS INTEGER
OPERATOR Not (BYREF cv AS DVARIANT) AS INTEGER
OPERATOR Or (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS INTEGER
OPERATOR Xor (BYREF cv1 AS DVARIANT, BYREF cv2 AS DVARIANT) AS INTEGER
```
...
DIM pcv AS DVARIANT PTR  = NEW DVARIANT("Test string")
Foo *pcv
Delete pcv
...
SUB Foo3 (BYREF cv AS DVARIANT)
   PRINT cv
END SUB
Foo3 DVARIANT(12345, "LONG")

SUB Foo4 (BYVAL cv AS DVARIANT PTR)
   PRINT *cv
END SUB
...
```
FUNCTION Round (BYREF cv AS DVARIANT, BYVAL cDecimals AS LONG) AS DVARIANT
```
...
FUNCTION Put (BYREF cv AS DVARIANT) AS HRESULT
...
```
FUNCTION AfxDVARIANTToStr OVERLOAD (BYREF cv AS DVARIANT) AS DWSTRING
```
...
```
FUNCTION AfxDVARIANTToStr OVERLOAD (BYVAL pcv AS DVARIANT PTR) AS DWSTRING
```

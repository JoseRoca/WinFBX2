...
Checking and fixing broken surrogates in is diabled by default for speed reasons. If you want to enable checking, use `#define \__AFX2_CHECKSURROGATES\__` at the beginning of your application, before including the files of this framework.
